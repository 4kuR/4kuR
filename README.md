...
Hi! I’m **Arukiya**, a Finnish man who values **loyalty, empathy, and growth**. I strive to create **judgment-free spaces** where people feel understood. With roots in **honesty and resilience**, I’m always eager to **learn and collaborate**.  
      ...
      <div class="col-md-10">
        <div class="social-bar">
          <div class="social-icons mb-3 iconpad text-center">
            <a href="#" target="_blank" class="slider-nav-item"><i class="fab fa-discord"></i></a>
            <a href="#" target="_blank" class="slider-nav-item"><i class="fab fa-youtube"></i></a>
            <a href="#" target="_blank" class="slider-nav-item"><i class="fab fa-twitch"></i></a>
            <a href="#" target="_blank" class="slider-nav-item"><i class="fab fa-discord"></i></a>
            <a href="#" target="_blank" class="slider-nav-item"><i class="fab fa-github"></i></a>
